...
$string['chart-user-view-time'] = "User View Time";
$string['chart-user-view-time-month'] = "User View Time In One Month";
$string['user-view-time'] = "User view time";
$string['user-view-count'] = "User count";
